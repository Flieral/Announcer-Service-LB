...
module.exports = function (campaign) {
  ...
  campaign.beforeRemote('prototype.__create__campaigns', function (ctx, modelInstance, next) {
  ...
  campaign.beforeRemote('prototype.__updateById__campaigns', function (ctx, modelInstance, next) {
    if (!ctx.args.options.accessToken)
      return next()
    ctx.args.data.clientId = ctx.args.options.accessToken.userId
    next()
